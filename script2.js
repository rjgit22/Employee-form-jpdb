...
function validatedData() {
            ...
            if (empid === "") {
                alert("Required Employee ID Value");
                $("#empid").focus();
                return "";
            }

            if (name === "") {
                alert("Required Employee Name Value");
                $("#name").focus();
                return "";
            }

            if (salary === "") {
                alert("Required Employee Salary Value");
                $("#salary").focus();
                return "";
            }

            if (hra === "") {
                alert("Required Employee HRA Value");
                $("#hra").focus();
                return "";
            }

            if (da === "") {
                alert("Required Employee DA Value");
                $("#da").focus();
                return "";
            }

            if (deduct === "") {
                alert("Required Employee Deduction Value");
                $("#deduct").focus();
                return "";
            }
